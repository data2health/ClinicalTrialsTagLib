...
public class ClinicalTrialsTagLibTagSupport extends TagSupport {

    protected DataSource theDataSource = null;
    protected Connection theConnection = null;
    private static final Log log = LogFactory.getLog(ClinicalTrialsTagLibTagSupport.class);

    public ClinicalTrialsTagLibTagSupport() {
        super();
    }
